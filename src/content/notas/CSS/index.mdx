...
<figure class="not-prose">
  <Image
    src={ColorImg}
    alt="una captura de pantalla de nulo.in en Safari en modo oscuro en donde los links estan de color azul oscuro"
  />
  <figcaption>
    nulo.in antes de que especifique colores para los links
  </figcaption>
</figure>
